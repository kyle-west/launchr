import { Painter, randGrey } from './lib/canvas.js';
import { LandingEvent } from './lib/events.js';

const G = 0.5
let LAUNCH_ATTEMPTS = 0

const updateAngleUI = (value) => document.getElementById('read-angle').innerHTML = value
...
function init () {
  ...
  const stars = makeStars(Math.floor((document.body.clientWidth + document.body.clientHeight) / 2))
